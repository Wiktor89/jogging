...
import com.example.jogging.service.JoogingService;
...
public class JoogingController {
    ...
    @Autowired
    private JoogingService service;

    @RequestMapping(value = Url.POST_JOOGING, method = RequestMethod.POST)
    public Jooging addJooging(@RequestBody Jooging jooging) {
        return service.addJooging (jooging);
    }
